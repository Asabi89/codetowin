...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    login(email || 'developpeur@codetowin.com');
  ...
  const handleSocialLogin = (provider) => {
    ...
    login(`${provider.toLowerCase()}user@codetowin.com`);
    navigate('/');
  };
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <div className="form-header-group">
              ...
              <a href="#forgot" className="forgot-link" onClick={(e) => { e.preventDefault(); alert("Fonctionnalité bientôt disponible !"); }}>
                Mot de passe oublié ?
              </a>
            </div>
            <input
