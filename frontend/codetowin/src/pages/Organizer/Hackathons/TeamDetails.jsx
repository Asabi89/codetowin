...
import { ChevronRight, Mail, UserX, Github, Globe, FileText, Image as ImageIcon, MessageCircle, RefreshCw, CheckCircle, Plus } from 'lucide-react';
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                <Badge variant="success" className="gap-1.5"><div className="h-2 w-2 rounded-full bg-green-600"></div> Projet soumis</Badge>
          ...
          <div className="flex gap-3">
            <Link to={`/organizer/hackathons/${id}/evaluation`} className="inline-flex items-center justify-center rounded-md bg-brand-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-brand-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600">
              <CheckCircle className="-ml-1 mr-2 h-5 w-5 text-brand-100" />
              Évaluer
            </Link>
            <button className="inline-flex items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50">
              <Mail className="-ml-1 mr-2 h-5 w-5 text-slate-400" />
              Contacter l'équipe
            </button>
            <button className="inline-flex items-center justify-center rounded-md bg-red-50 px-4 py-2 text-sm font-semibold text-red-700 shadow-sm hover:bg-red-100">
              Disqualifier
            </button>
          </div>
        </div>
            ...
            <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex gap-2">
                  <button className="flex flex-1 items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50">
                    Message
                  </button>
                  <button className="flex flex-1 items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50">
                    Changer
