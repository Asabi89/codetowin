...
export default function OrganizerNewAnnouncement() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await hackathonsApi.createAnnouncement(id, { title, content });
            ...
            <div className="px-4 py-5 sm:p-6">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-end space-x-4 pt-6 border-t border-slate-200">
                  ...
                  <button type="submit" disabled={loading} className="inline-flex justify-center rounded-md bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600 disabled:opacity-50">
