...
export default function ParticipantHeader() {
  ...
  const roleConfig = {
    participant: {
      ...
      messagesTo: '/participant/messages',
      notificationsTo: '/participant/notifications',
      badge: 'Participant',
    },
    mentor: {
      dashboardTo: '/mentor',
    ...
    organizer: {
      ...
      messagesTo: '/organizer/messages',
      notificationsTo: '/organizer/notifications',
          ...
          <div className="avatar-pill-wrap" ref={dropdownRef}>
            ...
            >
              ...
              <div className="dropdown-links">
                ...
                <Link
                  to={currentRoleConfig.messagesTo}
                  className="dropdown-link"
                  onClick={() => setDropdownOpen(false)}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Link
                  to={currentRoleConfig.notificationsTo}
                  className="dropdown-link"
                  onClick={() => setDropdownOpen(false)}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
